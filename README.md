...
```
$3 ==> [target/main/exploded/printer.logger/module-info.class, ...]
```
...
$6 ==> [target/main/artifact, target/main/artifact/printer.logger-1.0.jar, ...]
```
...
[compiler] javac --release 9
                 ...
                 src/main/java/printer.logger/module-info.java ...
[packager] jar --create
               --file target/main/artifact/printer.logger-1.0.jar
               --module-version 1.0
               -C target/main/exploded/printer.logger
               .
[packager] jar --create --file target/main/artifact/printer.main-1.0.jar
               --module-version 1.0
               --main-class com.acme.printer.main.Main
               -C target/main/exploded/printer.main
               .
[packager] jar --create
               --file target/main/artifact/printer.api-1.0.jar
               --module-version 1.0
               -C target/main/exploded/printer.api
               .
...
[packager] jar --create
               ...
               .
[packager] jar --create
               --file target/main/artifact/printer.main-1.0.jar
               --module-version 1.0
               --main-class com.acme.printer.main.Main
               -C target/main/exploded/printer.main
               .
